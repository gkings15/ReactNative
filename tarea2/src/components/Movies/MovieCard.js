...
export default class MovieCard extends Component {
  ...
  toggleInformation = () => this.setState(({ showInformation }) => ({ showInformation: !showInformation }));
  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.text} onPress={this.toggleInformation}>
          Ver descripción
        </Text>
        {
          showInformation && <StoryLine storyline={storyline} />
        }
        <GenderList genres={genres} />
